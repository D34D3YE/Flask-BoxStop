...
def sign_up():
    if request.method == 'POST' :
        ...
        if user:
            ...
            flash('Benutzername muss länger als 1 Zeichen sein!' , category ='error')
        elif (password1 != password2):
            flash('Passwörter stimmen nicht überein!', category='error')
        elif len(password1) < 7:
            flash('Passwort muss mindestens aus 7 Zeichen bestehen!', category='error')
        else:
            ...
            flash('Benutzer erfolgreich registriert!', category='success') 
            return redirect(url_for('views.home'))
